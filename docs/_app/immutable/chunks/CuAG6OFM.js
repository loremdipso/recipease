import{n as w}from"./BXZ9XKax.js";function C(e){return e.replaceAll("**","")}function M(e,t=1){let r=e.split(" ");for(;r.length>t;)r.shift();return r.join(" ")}function W(e){return e.replaceAll(/^\s+(\/\/.*)?/gm,"").replaceAll(`
