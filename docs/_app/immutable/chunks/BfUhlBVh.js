import{aJ as L}from"./awlFoezV.js";import{g as U,b as le,r as se}from"./CRTkdhWx.js";function D(e){return e.replaceAll("**","")}function Q(e,t=1){let r=e.split(" ");for(;r.length>t;)r.shift();return r.join(" ")}function P(e){return e.replaceAll(/^\s+(\/\/.*)?/gm,"").replaceAll(`
